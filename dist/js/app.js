 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".testimonial-slider__body")) new core(".testimonial-slider__body", {
        ...
        window.onload = function() {
            ...
            window.addEventListener("scroll", (function(event) {
                ...
                document.documentElement.classList.toggle("_fixed", scrolled > headerBottomOffset);
            }));
        };
        window["FLS"] = true;
        isWebp();
